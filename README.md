...
The first file of interest is (imdb.movies.csv.gz)
...
# data cleaning 
 ...
 tmdb.isnull()
  ...
  tmdb.isnull().sum() 
  getting count of all null values to confirm they have been dropped
...
Lets now check the dataframe for general info of the dataset
  #rt.info() 
